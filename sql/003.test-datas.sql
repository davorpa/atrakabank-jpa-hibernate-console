...
-- Afiliación banda organizada - delincuentes

INSERT INTO AFILIACION_BANDA (ID_BANDA, ID_DELINCUENTE) VALUES 
    (   (SELECT ID FROM BANDA_ORGANIZADA WHERE CODIGO = "BO0001"),
        (SELECT ID FROM DELINCUENTE WHERE IDENTIFICADOR = "1345423SG")   ),
    (   (SELECT ID FROM BANDA_ORGANIZADA WHERE CODIGO = "BO0002"),
        (SELECT ID FROM DELINCUENTE WHERE IDENTIFICADOR = "1345423SG")   ),
    (   (SELECT ID FROM BANDA_ORGANIZADA WHERE CODIGO = "BO0003"),
        (SELECT ID FROM DELINCUENTE WHERE IDENTIFICADOR = "1345423SG")   );

INSERT INTO AFILIACION_BANDA (ID_BANDA, ID_DELINCUENTE)
    SELECT (SELECT ID FROM BANDA_ORGANIZADA WHERE CODIGO = "BO0001"), 
           ID
    FROM DELINCUENTE
    WHERE IDENTIFICADOR LIKE '3%';

INSERT INTO AFILIACION_BANDA (ID_BANDA, ID_DELINCUENTE)
    SELECT (SELECT ID FROM BANDA_ORGANIZADA WHERE CODIGO = "BO0002"), 
           ID
    FROM DELINCUENTE
    WHERE IDENTIFICADOR LIKE '2%';
