...
-- Contrato
INSERT INTO CONTRATO(IDENTIFICADOR, FECHA_INICIO, FECHA_FIN, ID_SUCURSAL, ID_VIGILANTE) VALUES
    ("CONTR01",  STR_TO_DATE('2013-02-11', '%Y-%m-%d'), STR_TO_DATE('2022-01-30', '%Y-%m-%d'), (SELECT ID FROM SUCURSAL WHERE CODIGO = "BBVA01"),   (SELECT ID FROM VIGILANTE WHERE CODIGO = "12345678Z")),
    ("CONTR02",  STR_TO_DATE('2019-07-23', '%Y-%m-%d'), STR_TO_DATE('2022-01-30', '%Y-%m-%d'), (SELECT ID FROM SUCURSAL WHERE CODIGO = "BBVA02"),   (SELECT ID FROM VIGILANTE WHERE CODIGO = "11111111A")),
    ("CONTR03",  STR_TO_DATE('2011-01-21', '%Y-%m-%d'), STR_TO_DATE('2019-06-05', '%Y-%m-%d'), (SELECT ID FROM SUCURSAL WHERE CODIGO = "KTXBNK01"), (SELECT ID FROM VIGILANTE WHERE CODIGO = "26456534F")),
    ("CONTR04",  STR_TO_DATE('2020-05-21', '%Y-%m-%d'), STR_TO_DATE('2013-02-11', '%Y-%m-%d'), (SELECT ID FROM SUCURSAL WHERE CODIGO = "KTXBNK01"), (SELECT ID FROM VIGILANTE WHERE CODIGO = "874543GBD")),
    ("CONTR05",  STR_TO_DATE('2017-10-31', '%Y-%m-%d'), STR_TO_DATE('2019-02-11', '%Y-%m-%d'), (SELECT ID FROM SUCURSAL WHERE CODIGO = "SBDLL01"),  (SELECT ID FROM VIGILANTE WHERE CODIGO = "874543GBD")),
    ("CONTR06",  STR_TO_DATE('2022-12-15', '%Y-%m-%d'), STR_TO_DATE('2010-06-18', '%Y-%m-%d'), (SELECT ID FROM SUCURSAL WHERE CODIGO = "SBDLL01"),  (SELECT ID FROM VIGILANTE WHERE CODIGO = "23452342S")),
    ("CONTR07",  STR_TO_DATE('2010-06-18', '%Y-%m-%d'), STR_TO_DATE('2013-02-11', '%Y-%m-%d'), (SELECT ID FROM SUCURSAL WHERE CODIGO = "KTXBNK01"), (SELECT ID FROM VIGILANTE WHERE CODIGO = "98654334Y")),
    ("CONTR08",  STR_TO_DATE('2006-01-09', '%Y-%m-%d'), STR_TO_DATE('2013-01-02', '%Y-%m-%d'), (SELECT ID FROM SUCURSAL WHERE CODIGO = "SBDLL02"),  (SELECT ID FROM VIGILANTE WHERE CODIGO = "98654334Y")),
    ("CONTR09",  STR_TO_DATE('2013-01-02', '%Y-%m-%d'), STR_TO_DATE('2013-01-03', '%Y-%m-%d'), (SELECT ID FROM SUCURSAL WHERE CODIGO = "SBDLL02"),  (SELECT ID FROM VIGILANTE WHERE CODIGO = "78646563O")),
    ("CONTR010", STR_TO_DATE('2021-06-07', '%Y-%m-%d'), NULL,                                  (SELECT ID FROM SUCURSAL WHERE CODIGO = "SBDLL02"),  (SELECT ID FROM VIGILANTE WHERE CODIGO = "78646563O")),
    ("CONTR011", STR_TO_DATE('2016-06-09', '%Y-%m-%d'), NULL,                                  (SELECT ID FROM SUCURSAL WHERE CODIGO = "BBVA01"),   (SELECT ID FROM VIGILANTE WHERE CODIGO = "245625722D")),
    ("CONTR012", STR_TO_DATE('2016-12-31', '%Y-%m-%d'), NULL,                                  (SELECT ID FROM SUCURSAL WHERE CODIGO = "BBVA01"),   (SELECT ID FROM VIGILANTE WHERE CODIGO = "78646563O"))
    ("CONTR013", STR_TO_DATE('2014-10-31', '%Y-%m-%d'), NULL,                                  (SELECT ID FROM SUCURSAL WHERE CODIGO = "SBDLL01"),  (SELECT ID FROM VIGILANTE WHERE CODIGO = "874543GBD")),
    ("CONTR014", STR_TO_DATE('2012-08-09', '%Y-%m-%d'), NULL,                                  (SELECT ID FROM SUCURSAL WHERE CODIGO = "BBVA02"),   (SELECT ID FROM VIGILANTE WHERE CODIGO = "11111111A")),
    ("CONTR015", STR_TO_DATE('2022-01-31', '%Y-%m-%d'), NULL,                                  (SELECT ID FROM SUCURSAL WHERE CODIGO = "KTXBNK01"), (SELECT ID FROM VIGILANTE WHERE CODIGO = "12345678Z")),
    ("CONTR016", STR_TO_DATE('2022-01-31', '%Y-%m-%d'), NULL,                                  (SELECT ID FROM SUCURSAL WHERE CODIGO = "BBVA02"),   (SELECT ID FROM VIGILANTE WHERE CODIGO = "05326325Q")),
    ("CONTR017", STR_TO_DATE('2019-06-05', '%Y-%m-%d'), NULL,                                  (SELECT ID FROM SUCURSAL WHERE CODIGO = "SBDLL02"),  (SELECT ID FROM VIGILANTE WHERE CODIGO = "245625722D")),
    ("CONTR018", STR_TO_DATE('2013-07-14', '%Y-%m-%d'), NULL,                                  (SELECT ID FROM SUCURSAL WHERE CODIGO = "BBVA02"),   (SELECT ID FROM VIGILANTE WHERE CODIGO = "23452342S"));
